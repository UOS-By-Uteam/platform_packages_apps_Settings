...
public class Utilities {
    ...
    public static String getDevice() {
        return SystemProperties.get("ro.uos.device", Build.PRODUCT);
    }

    public static String getUOSVersion() {
        return SystemProperties.get("ro.uos.display.version", Build.DISPLAY);
    }
    ...
    public static String getModVersion() {
        return SystemProperties.get("ro.uos.version", Build.DISPLAY);
    }
    ...
    public static void setStatsCollectionEnabled(Context context, boolean enabled) {
        ...
        Settings.Secure.putInt(context.getContentResolver(),
                Settings.Secure.UOS_STATS, enable);
    }
}
