...
public class ReportingServiceManager extends BroadcastReceiver {
    ...
    public static final String ACTION_LAUNCH_SERVICE =
            "com.uos.settings.action.TRIGGER_REPORT_METRICS";
    ...
    public static void initiateOptOut(Context context) {
        final boolean optOutReported = Settings.Secure.getIntForUser(context.getContentResolver(),
                Settings.Secure.UOS_STATS_RECORDED, 0, UserHandle.USER_OWNER) == 1;
        if (!optOutReported) {
